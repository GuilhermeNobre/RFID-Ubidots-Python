...
const char *UBIDOTS_TOKEN = "BBFF-AAAudFIiy1zTdI7tOKp04aXruh1lgM";  // Put here your Ubidots TOKEN
const char *WIFI_SSID = "MAX";      // Put here your Wi-Fi SSID
const char *WIFI_PASS = "12456270";      // Put here your Wi-Fi password
